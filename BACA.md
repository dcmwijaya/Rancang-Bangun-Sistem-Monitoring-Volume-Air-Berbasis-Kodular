...
![GitHub last commit](https://img.shields.io/github/last-commit/dcmwijaya/Rancang-Bangun-Sistem-Monitoring-Volume-Air-Berbasis-Kodular?logo=Codeforces&logoColor=white&color=%23F7DF1E)
...
| Komponen Lainnya | • Kabel USB Mikro - USB tipe A (x1)<br>• Kabel jumper (1 set)<br>• Adaptor DC 5V (x1) |
